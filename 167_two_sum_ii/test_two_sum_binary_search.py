...
from two_sum_binary_search import Solution
...
class TestTwoSumII(unittest.TestCase):
    ...
    def test_example_1(self):
        ...
        target = 9
        expected = [1, 2]
        self.assertEqual(self.solution.two_sum_binary_search(numbers, target), expected)
    ...
    def test_first_element_not_in_solution(self):
        # This test would trigger the infinite loop in the original code
        numbers = [1, 3, 4, 5]
