...
from reverse_linked_list_recursive import ListNode, Solution
...
class TestReverseLinkedListRecursive(unittest.TestCase):
    def setUp(self):
        self.solution = Solution()

    def test_empty_list(self):
        head = list_to_linked_list([])
        reversed_head = self.solution.reverse_linked_list_recursive(head)
